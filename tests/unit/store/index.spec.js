...
describe('In App Component', () => {
  it('SET_SEARCHRESULTS mutation should set state.allShowsList value to allShowsList', () => {
  ...
  it('SET_EPISODEDETAILS mutation should set state.allShowsList value to allShowsList', () => {
  ...
  it('SET_SEASONDETAILS mutation should set state.allShowsList value to allShowsList', () => {
  ...
  it('SET_SHOWDETAILS mutation should set state.allShowsList value to allShowsList', () => {
    const data = {
          'Drama': {
            'label': 'Drama',
            'value':  [
  ...
  it('SET_SHOWDATA mutation should set state.allShowsList value to allShowsList', () => {
    const data = {
      "id":1,
      "url":"http://www.tvmaze.com/shows/1/under-the-dome",
      "name":"Under the Dome",
  ...
  it('SET_SHOWNAME mutation should set state.allShowsList value to allShowsList', () => {
    const data = 'Drama'
...
describe('In App Component', () => {
  ...
  it('SET_SHOWNAME mutation should set state.allShowsList value to allShowsList', async () => {
    await actions.getShowsList(context)
  })
  it('SET_SHOWNAME mutation should set state.allShowsList value to allShowsList', async () => {
    const dataone = {'query':'arrow'}
    await actions.getSearchResults(context, dataone)
  })
  it('SET_SHOWNAME mutation should set state.allShowsList value to allShowsList', async () => {
